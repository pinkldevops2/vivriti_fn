...
//     let html = `
//   <li class="py-2 cursor-pointer rounded mb-2 ${activeCategory === "all" ? "bg-gradient-to-r " : ""}" data-slug="all">
//     <a>All</a>
//   </li>
// `;
let html ='';
...
function filterAndRender() {
  ...
  renderPage(1);
  renderTopNews(filteredData); // optional: update top news
}
...
let a = `
  <div class="blog-card flex flex-col gap-2">
    ...
    <div class="blog_body">
     ...
     <!-- <p class="pt-2 text-[15px] leading-[24px] text-[#444] blogdetails">
        ${item.excerpt || item.blog.description?.substring(0, 130)}
      </p>-->
...
`;
  ...
  a += `<div class="col-span-2 w-full border-b border-dashed border-[#F2994A] mb-3"></div>`;
}
...
function renderPagination() {
 ...
 async function loadInitial() {
  ...
  posts(first: 1000) {
    ...
    renderTopNews(newsData);       // OR rename to renderTopPosts()
